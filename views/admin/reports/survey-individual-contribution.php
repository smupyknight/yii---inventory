...
<section id="page-content">
                ...
                <div class="header-content">
                    ...
                    <div class="breadcrumb-wrapper hidden-xs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <?php echo Html::a('Quarterly Contribution', ['surveyquarter' , 'id'=> $id , 'quarter' => $quarter]);?>
                                <i class="fa fa-angle-right"></i>
                            </li>
                             <li class="active"><?php echo Html::encode("Individual Contribution");?></li>
                        </ol>
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <div class="row">
                        <div class="col-md-12">
<div class="panel panel-body"><strong>Node : <?php echo $nodeDetail['name'];?></strong></div>
                           <!-- Start danger color table -->
                           <p>
        					<?php echo Html::a('Reset', ['individualcontribution', 'id' => $id, 'quarter' => $quarter, 'node_id' => $node_id], ['class' => 'btn btn-default']) ?>
   						  </p>
