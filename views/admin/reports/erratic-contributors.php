...
$this->title = 'Erratic Contributors for last 2 quarters';
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                           ...
                           <p>
                            <?php echo Html::a('Inactive Contributors', ['inactivecontributors'], ['class' => 'btn btn-warning']) ?>
                            <?php echo Html::a('Excluded Contributors', ['excludedcontributors'], ['class' => 'btn btn-danger']) ?>
                            <?php echo Html::a('Reset', ['erraticcontributors'], ['class' => 'btn btn-default']) ?>
   						  </p>
                    	...
                    	<?php endif; ?>
                            ...
                            ['class' => 'yii\grid\SerialColumn'],
                                        ...
                                        'class'       => 'form-control',
                                            ...
                                            'quarter',
                                            [
                                              'attribute'=>'incomplete_survey',
                                              'label' => 'Incomplete Survey',
                                            ],
                                            [
                                              'attribute'=>  'missed_survey_data',
                                              'label' => 'No. of missed Survey data',
                                            ],
                                            ];?>
                ...
                'buttons' => 
                    [
                        'exclude' => function($url, $model, $key) {
                            ...
                            return Html::a($string,['togglestatus', 'id' => $model['user_id'], 'status' => $model['disabled']], ['class' => 'btn btn-xs '.$class, "data-id" => $model['user_id'] , "data-included" => $model['disabled']]
                            );
