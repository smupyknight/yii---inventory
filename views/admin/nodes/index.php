...
$this->title = 'Manage Parent Nodes';
                    ...
                    <div class="row">
                        <div class="col-md-12">
                           ...
                           <div class="row">
								...
								?>
                                <?php echo $form->field($searchModel, 'property_type_id')->dropDownList($propertyTypes)->label('Property Type');?>
                                 <?php echo Html::submitButton('Filter', ['class' => 'btn btn-success']);?>
                                <?php ActiveForm::end();?>
                           </div>
                           <div class="clearfix"></div>
                           <p>
        					<?php echo Html::a('Create Parent Node', ['create', 'id' => $searchModel->property_type_id], ['class' => 'btn btn-success']) ?>
                    	...
                    	<?php endif; ?>
                            ...
                            <?php echo Html::input('hidden', 'per_page',(isset($_GET['per-page'])) ? $_GET['per-page'] : 0,['id' => 'per_page']) ?>
                                <?= GridView::widget([
									...
									.Html::a('<i class="fa fa-eye"></i>', ['childnodes', 'parent' => $model->id], ['class' => 'btn btn-success btn-xs ' ,'data-toggle'=>'tooltip' ,"data-placement"=>"top", 'data-pjax' => '0']);				
													}
														},
													]
											],
