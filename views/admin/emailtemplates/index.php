...
/* @var $searchModel app\models\SearchEmailTemplates */
            							...
            							['class' => 'yii\grid\SerialColumn'],
											...
											[
    											...
    											'content' => function ($model, $key, $index, $column) {
													...
													Html::a('<i class="fa fa-eye"></i>', ['view', 'id' => $model->id], ['class' => 'btn btn-success btn-xs ' ,'data-toggle'=>'tooltip' ,"data-placement"=>"top"]);
